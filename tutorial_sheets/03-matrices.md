...
<div class = "answer" markdown="1"> $\Rightarrow{} BA^T=(AB^T)^T$ and $(AB)^T=B^TA^T$</div>
...
(d) $A+C$
<div class = "answer" markdown="1"> Operation is not possible. Two matrices must have an equal number of rows and columns to be added.</div>

(e) $CA$
<div class = "answer" markdown="1"> Operation not possible, $C_{2x4}A_{3x2}$</div>
...
<div class = "answer" markdown="1"> $[(2\times3)(3\times3)^T(2\times3)-(3\times3)](3\times1)=\boxed{(3\times1)}$ [2 marks]</div>
<div class = "workingout"><br><br><br><br><br><br><br><br></div>
...
<div class = "answer" markdown="1"> $Det(\textbf{M}) = k(0+8)-2(3-4)+1(-6)= \boxed{8\textit{k}-4}$</div>
